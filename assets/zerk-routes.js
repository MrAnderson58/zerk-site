...
(function () {
  ...
  const CATEGORIES = {
    collection: {
      ...
      description:
        'Полная коллекция ZERK TOOL: кусачки для кутикулы, ножницы Solingen, сменные файлы, пушеры и нитриловые перчатки. Японская сталь, ручная заточка.',
      intro:
        'ZERK TOOL — премиальный бренд инструмента для nail-мастеров и салонов. В коллекции — кусачки из стали SUS 420 J2, ножницы из Германии, абразивы на металлическую основу и расходники для гигиеничного протокола.',
    },
    nippers: {
      path: '/nippers',
      cat: 'nippers',
      ...
      description:
        'Профессиональные кусачки ZERK TOOL IL-02…IAL-01: SUS 420 J2, лезвия 4–8 мм, ручная заточка, производство во Вьетнаме. Для мастеров и салонов.',
      intro:
    ...
    'nitrile-gloves': {
      ...
      grid: true,
      h1: 'Перчатки нитрил ZERK TOOL',
      title: 'Нитриловые перчатки ZERK TOOL NG-100 — без пудры',
      description:
        'Перчатки нитрил ZERK TOOL NG-100: 100 шт, размеры S / M / L, без пудры. Для мастеров маникюра и салонов красоты.',
      intro:
        'Нитриловые перчатки ZERK TOOL — тактильный контроль, плотное прилегание и гигиена рабочего места. Упаковка 100 пар без пудры.',
    },
    pushers: {
      path: '/pushers',
      cat: 'pushers',
    ...
    about: {
      ...
      intro:
        'ZERK TOOL объединяет инженерный подход и эстетику luxury beauty: кусачки, ножницы, абразивы и аксессуары для мастеров, которые ценят предсказуемый результат и долговечность инструмента.',
    },
    contacts: {
      path: '/contacts',
      cat: null,
