...
Не выдумывай цены и наличие — предложи связаться с менеджером.`;
  ...
  function localReply(text) {
    ...
    return 'Могу подсказать по моделям <strong>IL-03, IL-07, IL-09, IL-12</strong>, размерам лезвия и стерилизации. Напишите задачу или выберите подсказку ниже. Для заказа — <a href="' + CONFIG.telegram + '" target="_blank" rel="noopener">Telegram</a>.';
  }
